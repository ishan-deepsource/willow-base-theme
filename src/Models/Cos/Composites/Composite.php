...
namespace Bonnier\Willow\Base\Models\Cos\Composites;
 ...
 * Class Composite
 *
 * @package \Bonnier\Willow\Cos\Models
 */
class Composite implements CompositeContract
{
    ...
    {
        return $this->composite->getRelatedByCategoryQuery()->setMatchingMode(WidgetDocumentQuery::RELATED_MAX_1_YEARS);
    }
